...
![最优哈希函数个数](../../storage/resources/Bloom_Filter_bestNum.jpg)
...
![cuckoo_hashing](../../storage/resources/cuckoo_hashing.jpg)
...
2. 寻找第二个bucket的方法：由于计算key的存储位置使用的时key本身的值，而存储时仅存储了fingerprint，因此当key被挤出，需要重新找位置时，通过指纹信息来找到第二个bucket
   ...
   ![图](../../storage/resources/cuckoo_filter_bucket1.jpg)

   通过异或来实现，所以

   ![图](../../storage/resources/cuckoo_filter_bucket2.jpg)
   ...
   ![cuckoo_filter](../../storage/resources/cuckoo_filter.png)
